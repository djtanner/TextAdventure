    ...
    rooms: [
      {
        ...
        desc:  `The year is 1984. You are in a video arcade in the local mall. The neon lights and electronic sounds overwhelm your senses as you take in the rows of arcade machines lining the walls. 
        ...
        onLook: () => {
          ...
          room.desc = `You are currently standing in the main area of the arcade. There's a  **PAC-MAN MACHINE** to your right, and a row of pinball machines behind you.
  
          To the **NORTH** is the **RECEPTION DESK**.
        ...
        items: [
          ...
          {
            name: ['pac-man', 'pacman', 'pacman machine'], // player can refer to this item by any of these names
            desc: `It\'s a yellow cabinet with a flickering screen. The top 3 high scores are all by the initials XKD.
            ...
            onLook: () => {
              ...
              arcade.items.push({
                name: ['shiny thing', 'silver key', 'something shiny'],
                onUse() {
                  const room = getRoom(disk.roomId);
                  if (room.id === 'arcade') {
                    println(`There's nothing to unlock in the arcade.`);
                ...
                onLook() {
                  ...
                  key.desc = `It has a green cap with the word "BOSS" printed on it.`;
          ...
          },
          {
            ...
            *Now it's in your **inventory**, and you can use it at any time, in any room. (Don't spend it all in one place!)
            ...
            //  println(`You flip the dime. It lands on ${side}.`);
                println(`You put the dime in the Pac-Man machine.Welcome to 'Arcade Adventure'! You are now the hero of this video game world. Your mission: to save the arcade from an evil virus that is infecting all of the games. You must travel through each game and defeat the virus before it destroys them all!`)
